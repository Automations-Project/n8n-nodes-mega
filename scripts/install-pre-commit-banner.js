...
# Updates README banner before commit and stages the image and config.

echo "[pre-commit] Updating README banner (auto-bumping version)..."
...
# Stage the updated banner file and config
if git rev-parse --git-dir > /dev/null 2>&1; then
  git add intro.png 2>/dev/null || true
  git add scripts/banner.config 2>/dev/null || true
  echo "[pre-commit] Staged intro.png and scripts/banner.config"
fi
